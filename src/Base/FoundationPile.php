...
class FoundationPile extends Pile {
     ...
     * 
     * @param \Solitaire\Base\Card $card card to be added to this pile
     * @param \Solitaire\Base\Pile $src the pile from which the card comes
     * @return boolean
     */
     ...
     * 
     * @param \Solitaire\Base\Pile $dest Pile to which the card to be added
     * @return boolean
     */
